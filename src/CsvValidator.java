...
public class CsvValidator {
    ...
    private static boolean validateInformations(){
        ...
        if(!Read.validateTimetableIdDupliacatedInFile(Arrays.asList(Main.divisionManager))) return false;
        if(!Read.validateSubjectIdDupliacated(Arrays.asList(Main.teacherManager))) return false;
